    ...
    <div className="relative min-h-screen w-full text-white overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full z-[-1]">
        <video 
          ...
          poster="https://images.unsplash.com/photo-1473496169904-658ba7c44d8a?q=80&w=1920&auto=format&fit=crop"
          data-ai-hint="ocean ship sailing"
        >
          {/* Using a placeholder video. A real video URL should be placed here. */}
          <source src="https://cdn.coverr.co/videos/coverr-a-ship-sailing-through-the-ocean-6194/1080p.mp4" type="video/mp4" />
